...
public class MaxIntegerTest {
	...
	public void givenInteger_ReturnsFirstMaximum() {
		int res1 = (Integer) obj.checkMaximum(90, 36, 74, 30);
	...
	public void givenInteger_ReturnsSecondMaximum() {
		int res2 = (Integer) obj.checkMaximum(40, 50, 30, 21);
	...
	public void givenInteger__ReturnsThirdMaximum() {
		int res3 = (Integer) obj.checkMaximum(30, 40, 80, 75);
	...
	public void givenFloat_ReturnsFirstMaximum() {
		float res1 = (Float) obj.checkMaximum(93.5f, 30.7f, 72.0f, 76.2f);
	...
	public void givenFloat_ReturnsSecondMaximum() {
		float res2 = (Float) obj.checkMaximum(42.8f, 52.7f, 33.3f, 34.4f);
	...
	public void givenFloat__ReturnsThirdMaximum() {
		float res3 = (Float) obj.checkMaximum(39.1f, 40.0f, 80.5f, 76.8f);
	...
	public void givenString_ReturnsFirstMaximum() {
		String res1 = (String) obj.checkMaximum("Orange", "Apple", "Banana", "Blueberries");
	...
	public void givenString_ReturnsSecondMaximum() {
		String res2 = (String) obj.checkMaximum("Beetroot", "Turnip", "Carrot", "Radish");
	...
	public void givenString__ReturnsThirdMaximum() {
		String res3 = (String) obj.checkMaximum("Close", "On", "Save", "Off");
